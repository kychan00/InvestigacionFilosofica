...
import {
  ...
  rankQuery,
  spearman,
} from "../scripts/benchmark/qwen3/analyze_ranking_512_development.mjs";
...
test("analyzer pins frozen 512, 4096 and pool artifacts and never uses human labels", async () => {
  const source = await readFile(
    "scripts/benchmark/qwen3/analyze_ranking_512_development.mjs",
    "utf8",
  );
