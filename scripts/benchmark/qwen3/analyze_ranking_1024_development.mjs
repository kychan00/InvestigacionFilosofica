...
const EXPERIMENT_ID =
  "qwen3-ranking-1024-development-v1";

const PREREG_PATH =
  "benchmark/qwen3/ranking/1024-development/qwen3-ranking-1024-development-v1.preregistered.json";

const CANDIDATE_PATH =
  "benchmark/qwen3/ranking/1024-development/scores/qwen3-ranking-1024-development-v1.raw.jsonl";

const CANDIDATE_META_PATH =
  "benchmark/qwen3/ranking/1024-development/scores/qwen3-ranking-1024-development-v1.raw.meta.json";
...
const REPORT_PATH =
  "benchmark/qwen3/ranking/1024-development/reports/qwen3-ranking-1024-development-v1.report.json";

const MARKDOWN_PATH =
  "benchmark/qwen3/ranking/1024-development/reports/qwen3-ranking-1024-development-v1.report.md";

const EXPECTED = {
  prereg:
    "9101210b49f8cdf8c90b7c8f9caa4b650a9f154bd692c3ce1e180e16f3bffb6b",
  candidate:
    "93618268d803c7221a116f07c5b65886f7d0e7881e7c9085eba65eb20d6d49b7",
  candidateMeta:
    "e7772d7bdf550b7d0572ed2b02a0ecafaa624b333f2ce2d0b32063d4c2d7c1f7",
  reference:
...
async function analyze() {
  ...
  const report = {
    schema_version:
      "qwen3-ranking-1024-development-report-v1",
    experiment_id: EXPERIMENT_ID,
    status:
  ...
  await mkdir(
    "benchmark/qwen3/ranking/1024-development/reports",
    { recursive: true },
  );
  ...
  const markdown = `# Qwen3 1024-token development ranking comparison
...
`;
  ...
  console.log(
    "Qwen3 1024 development comparison complete",
  );
